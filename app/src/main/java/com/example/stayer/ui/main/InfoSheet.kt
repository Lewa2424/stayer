    ...
    Column(
        ...
        InfoText(
            "Карточки автоматически переключаются:\n" +
                    ...
                    "\uD83D\uDCA1 При потере GPS (туннель, глушилки) включится умный шагомер: " +
                    "он запоминает ваш темп и продолжает точно считать дистанцию. Убедитесь, что разрешили доступ к фитнес-данным (шагомеру) в окне Проверки готовности."
        )
        Spacer(Modifier.height(20.dp))
        HorizontalDivider()
        Spacer(Modifier.height(20.dp))
