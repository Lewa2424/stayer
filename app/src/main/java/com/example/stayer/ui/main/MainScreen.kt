...
private fun InfoBottomSheetContent(
    ...
    Column(
        ...
        // ── О приложении ──
        Text(
            text = "Stayer \u2014 приложение для управления темпом беговых тренировок. " +
                    "Отслеживает дистанцию по GPS и шагомеру, рассчитывает текущий темп " +
        ...
        InfoText(
            "Карточки автоматически переключаются:\n" +
                    "\u2022 Время \u2192 Фаза (Разминка / Работа / Отдых / Заминка)\n" +
                    "\u2022 Дистанция \u2192 Номер серии\n" +
        ...
        InfoText(
            "\u2022 Нажмите иконку \u231A в правом верхнем углу\n" +
                    "\u2022 Каждая запись содержит: дату, дистанцию, время, средний темп, режим\n" +
